        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-[720px]">
            <div className="flex items-center gap-3">
              <StoneLogo className="h-8 w-auto" />
              <span className="text-lg font-black tracking-[0.2em] text-stone-900">STONE</span>
            </div>
            <p className="mt-2 overflow-hidden text-ellipsis whitespace-nowrap text-[12px] font-semibold leading-5 text-stone-500">
              STONE은 실물 기반 토큰증권 자산 정보를 탐색하고, 공시 및 거래 흐름을 함께 확인할 수 있도록 구성한 STO 플랫폼입니다.
            </p>
          ...
          <div className="grid gap-8 lg:min-w-[620px] lg:grid-cols-[120px_140px_minmax(0,1fr)]">
            <div>
              <div className="mb-2 text-[12px] font-black text-stone-800">플랫폼</div>
            ...
            <div>
              <div className="mb-2 text-[12px] font-black text-stone-800">정책</div>
              <div className="space-y-1.5">
            ...
            <div className="text-[12px] font-semibold leading-5 text-stone-500">
              <p>AI 요약과 뉴스 정보는 참고용이며 투자 판단의 책임은 이용자에게 있습니다.</p>
              <p>서비스 정책과 이용 조건은 이용약관 및 개인정보처리방침에서 확인할 수 있습니다.</p>
            </div>
          </div>
        </div>
