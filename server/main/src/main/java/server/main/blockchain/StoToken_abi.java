...
public class StoToken_abi extends Contract {
    ...
    @Deprecated
    protected StoToken_abi(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected StoToken_abi(String contractAddress, Web3j web3j,
    ...
    public RemoteFunctionCall<TransactionReceipt> recordTrade(String seller, String buyer,
            BigInteger amount) {
        final Function function = new Function(
                FUNC_RECORDTRADE, 
    ...
    @Deprecated
    public static StoToken_abi load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new StoToken_abi(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static StoToken_abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new StoToken_abi(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static StoToken_abi load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new StoToken_abi(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static StoToken_abi load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new StoToken_abi(contractAddress, web3j, transactionManager, contractGasProvider);
    }
