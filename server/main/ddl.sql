...
CREATE TYPE wallet_role_enum       AS ENUM ('MEMBER', 'PLATFORM_TREASURY', 'ISSUER');
...
CREATE TABLE COMMONS (
    base_id           BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE WALLETS (
    ...
    wallet_role wallet_role_enum NOT NULL DEFAULT 'MEMBER',
...
CREATE TABLE BANKINGS (
    banking_id       BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE ASSET_ACCOUNTS (
    asset_account_id      BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id              BIGINT    NOT NULL,
...
CREATE TABLE ASSET_BANKINGS (
    asset_banking_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE PLATFORM_ACCOUNTS (
    platform_account_id      BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE PLATFORM_TOKEN_HOLDINGS (
    platform_token_holding_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE TOKEN_HOLDINGS (
    token_holding_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    member_id        BIGINT        NOT NULL,
    token_id         BIGINT        NOT NULL,
    updated_at       TIMESTAMP     NOT NULL DEFAULT NOW(),
...
CREATE TABLE ALLOCATION_EVENTS (
    allocation_event_id     BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id                BIGINT    NOT NULL,
    created_at              TIMESTAMP NOT NULL DEFAULT NOW(),
...
CREATE TABLE ALLOCATION_PAYOUTS (
    allocation_payout_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    member_id            BIGINT             NOT NULL,
...
CREATE TABLE PLATFORM_BANKING (
    platform_banking_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE DISCLOSURE (
    disclosure_id       BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id            BIGINT              NOT NULL,
    created_at          TIMESTAMP           NOT NULL DEFAULT NOW(),
    updated_at          TIMESTAMP           NOT NULL DEFAULT NOW(),
...
CREATE TABLE LOGIN_LOG (
    login_log_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE API_LOG (
    api_log_id       BIGINT GENERATED BY DEFAULT AS IDENTITY,
    member_id        BIGINT       NULL,
...
CREATE TABLE CANDLE_MINUTES (
    candle_id   BIGINT GENERATED BY DEFAULT AS IDENTITY,
    token_id    BIGINT        NOT NULL,
